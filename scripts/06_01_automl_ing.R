...
###### variables transformadas con medidas generadas con ingenieria de variables y seleccionadas con stepwise #############
...
las_var <- read_rds("data/var_ing.rds")
...
write_rds(aml, "data/modelos/04_aml_h2o_ing_mod.rds")
