...
En los siguientes puntos vamos a describir las condiciones de borde, ya que el objetivo es describir un problema que normalmente se resuelve de manera deterministica y lenta, y la introducción de tecnicas de machine learning nos permite acceder a soluciones que aumentan nuestra productividad y calidad de las predicciones.
...
Al observar las estadísticas no vemos a simple vista ningun problema salvo la necesidad inicial de realizar imputaciones para decidir qeu curvas vamos a utilizar
