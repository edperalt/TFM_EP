...
###### variables con los residuales al eliminar la tendencia con profundidad y seleccionadas con stepwise #############
...
las_var <- read_rds("data/var_re.rds")
...
write_rds(aml, "data/modelos/04_aml_h2o_re_mod.rds")
