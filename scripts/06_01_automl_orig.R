...
###### variables transformadas con medidas originales y seleccionadas con stepwise #############
...
las_var <- read_rds("data/var_orig.rds")
...
write_rds(aml, "data/modelos/04_aml_h2o_orig_mod.rds")
