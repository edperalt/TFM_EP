...
###### variables escogidas por un geologo conservador y seleccionadas con stepwise #############
...
las_var <- read_rds("data/var_geo2.rds")
...
write_rds(aml, "data/modelos/04_aml_h2o_geo2_mod.rds")
